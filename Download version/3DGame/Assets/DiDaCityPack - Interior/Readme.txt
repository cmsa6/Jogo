...
Some exceptions of assets that don't use these materials are objects like posters or picture frames where they need their own specific texture that is provided.
We also included descriptive images to help you visualize the whole content

Why is the interiors scenes not present in the pack?
	...
	Second, the interiors scenes was built in Blender files so you wouldn't be able to do anything with them, since they were not built in game-engines.
	Third, and unfortunately, the files where the interior scenes was built were lost and we were not able to recover them.
